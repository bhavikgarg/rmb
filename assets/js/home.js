$(document).ready(function() {
    ...
    // send to goodies page

    
    $('.loadGoodies').on('click', function(){
      $(this).css('background-color','white');
      var id = $(this).attr('id');
      console.log(id);
      // update the isSeen attribute to y
      $.ajax({
        url : 'updateStatus.php?id='+id,
        type : 'GET',
        success : function(d)
        {
          console.log("Recieved is :"+d);
        },
        error : function(err)
        {
    ...
    $('.loadAdminGoodies').on('click', function(){
      $(this).css('background-color','white');
      var id = $(this).attr('id');
      console.log(id);
      // update the isSeen attribute to y
    ...
    $('#viewAllGoodies').on('click', function(){
      $.ajax({
