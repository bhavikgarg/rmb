...
$username = $_SESSION['username'];  // replace with SESSION username
   // replace with SESSION group name

$sql = "SELECT * from goodies WHERE sendTo = 'rmb'";
$countUnSeen = "SELECT count(*) c from goodies WHERE isSeen = 'n' AND sendTo = 'rmb'";
                  ...
                  <li>
                    ...
                    <?php
                      while($row = mysqli_fetch_array($result, MYSQLI_ASSOC))
                      {
                        ...
                        echo "<li style = 'background-color : ".$color."'  class = 'loadAdminGoodies' id = ".$row['id']."><a href = '#'><i class='fa fa-shopping-cart'></i> Recieved goodie from ".$row['sentBy']."</li>";
                      }
                    ?>
